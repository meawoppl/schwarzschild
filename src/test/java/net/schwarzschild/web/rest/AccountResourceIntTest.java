...
import net.schwarzschild.config.Constants;
import net.schwarzschild.SchwarzschildApp;
import net.schwarzschild.domain.Authority;
import net.schwarzschild.domain.User;
import net.schwarzschild.repository.AuthorityRepository;
import net.schwarzschild.repository.UserRepository;
import net.schwarzschild.security.AuthoritiesConstants;
import net.schwarzschild.service.MailService;
import net.schwarzschild.service.dto.UserDTO;
import net.schwarzschild.web.rest.errors.ExceptionTranslator;
import net.schwarzschild.web.rest.vm.KeyAndPasswordVM;
import net.schwarzschild.web.rest.vm.ManagedUserVM;
import net.schwarzschild.service.UserService;
