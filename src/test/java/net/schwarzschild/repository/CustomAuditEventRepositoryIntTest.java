...
import net.schwarzschild.config.audit.AuditEventConverter;
import net.schwarzschild.domain.PersistentAuditEvent;
...
import static net.schwarzschild.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
