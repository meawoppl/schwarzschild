...
import net.mattyg.config.audit.AuditEventConverter;
import net.mattyg.domain.PersistentAuditEvent;
...
import static net.mattyg.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
