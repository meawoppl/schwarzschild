...
import net.mattyg.config.Constants;
import net.mattyg.SchwarzschildApp;
import net.mattyg.domain.Authority;
import net.mattyg.domain.User;
import net.mattyg.repository.AuthorityRepository;
import net.mattyg.repository.UserRepository;
import net.mattyg.security.AuthoritiesConstants;
import net.mattyg.service.MailService;
import net.mattyg.service.dto.UserDTO;
import net.mattyg.web.rest.errors.ExceptionTranslator;
import net.mattyg.web.rest.vm.KeyAndPasswordVM;
import net.mattyg.web.rest.vm.ManagedUserVM;
import net.mattyg.service.UserService;
