package net.schwarzschild.config.social;

import net.schwarzschild.repository.SocialUserConnectionRepository;
import net.schwarzschild.repository.CustomSocialUsersConnectionRepository;
import net.schwarzschild.security.jwt.TokenProvider;
import net.schwarzschild.security.social.CustomSignInAdapter;
